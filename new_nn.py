...
def Actor(input_shape, output_shape, lr):
    ...
    x = Conv2D(16, (8, 8), padding="same", activation="relu", dtype='float32')(X_input)
    print(x)
...
class Hypernetwork_PONG(keras.Model):
    ...
    def __init__(self, name):
        super(Hypernetwork_PONG, self).__init__()
        ...
        self.w1_dense_2 = Dense(65, activation="relu") 
        
        self.w2_dense_1 = Dense(60, activation="relu")
        self.w2_dense_2 = Dense(257, activation="relu")

        self.w3_dense_1 = Dense(200, activation="relu")
        self.w3_dense_2 = Dense(3201, activation="relu")

        self.w4_dense_1 = Dense(60, activation="relu")
        self.w4_dense_2 = Dense(257, activation="relu")
    ...
    def call(self, inputs):
        ...
        input_w2 = tf.reshape(input_w1,(layer_2,-1))
